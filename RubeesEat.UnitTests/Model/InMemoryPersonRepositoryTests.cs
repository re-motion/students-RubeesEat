...
public class InMemoryPersonRepositoryTests
{
    ...
    [Test]
    public void GetPersonById_IsInDictionary_ReturnsCurrentUser()
    {
        Person defaultUser = new Person(Guid.NewGuid(), "DefaultFirstName", "DefaultLastName");
        ...
        Assert.That(personRepository.GetById(defaultUser.Id),
            Is.EqualTo(defaultUser)); // in this case reference equals is fine because its the same object
    }
}
