...
public class RubeesEatSeleniumTests() : SeleniumIntegrationTestBase("UserHomepage")
{
    ...
    public void GetDefaultBalanceChanges()
    {
        ...
        Assert.That(balanceChanges[1].Amount, Is.EqualTo("1000000,50\u20ac"));
        ...
        Assert.That(balanceChanges[4].Amount, Is.EqualTo("-800€"));
    ...
    public void ClickBalanceChange()
    {
        ...
        Assert.That(billDetailPage.Date, Is.AnyOf("Dienstag, 19. August 2025", "Tuesday, 19 August 2025"));
